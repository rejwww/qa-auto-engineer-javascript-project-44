...
Команда **make brain-games** - быстрый запуск игры.

Команда **make publish** - публикации пакета в npm для доступа установки другими участниками проекта.

Команда **make lint** - запуск Eslint (проверка кода на соответствие стандартам).

Команда **make brain-even** - быстрый запуск игры "Проверка на чётность".

Команда **make brain-calc** - быстрый запуск игры "Калькулятор".

Команда **make brain-gcd** - быстрый запуск игры "НОД".

Команда **make brain-progression** - быстрый запуск игры "Арифметическая прогрессия".

Команда **make brain-prime** - быстрый запуск игры "Простое ли число?".

Команда **make start-by-name** - доступность запуска по названию игры. (предварительно выполнить команду chmod +x bin/name_game.js, где name_game.js - файл с игрой.)
